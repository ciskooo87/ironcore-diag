            ...
            return (
              <section key={project.id} className="rounded-[28px] border border-black/5 bg-white p-6 surface-elevated md:p-7">
                ...
                <div className="mt-4 grid gap-2 sm:grid-cols-[1.2fr_0.8fr]">
                  ...
                  <Link href={`/projetos/${project.code}/cadastro/`} className="rounded-2xl border border-black/5 bg-[#F8FAFC] px-4 py-3 text-center text-sm text-[#475467] hover:border-black/10 hover:text-[#101828]">Abrir</Link>
                </div>
