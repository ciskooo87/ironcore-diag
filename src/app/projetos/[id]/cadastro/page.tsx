...
function ParameterCard({ title, description, children }: { title: string; description: string; children: React.ReactNode }) {
  return <div className="rounded-2xl border border-black/5 bg-[#F8FAFC] p-4 md:p-5"><div className="text-xs uppercase tracking-[0.18em] text-[#98A2B3]">{title}</div><div className="mt-1 text-xs text-[#98A2B3]">{description}</div><div className="mt-3 grid gap-3">{children}</div></div>;
}
