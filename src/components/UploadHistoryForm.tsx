...
export function UploadHistoryForm({ action, kind, label, defaultDate, templateHref }: { action: string; kind: string; label: string; defaultDate: string; templateHref: string }) {
  ...
  return (
    <form ref={formRef} encType="multipart/form-data" className="min-w-0 rounded-2xl border border-black/5 bg-[#F8FAFC] p-4 text-sm overflow-hidden" onSubmit={handleSubmit}>
