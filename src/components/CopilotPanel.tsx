  ...
  return (
    <div className="space-y-3">
      <div className="rounded-2xl border border-slate-800 bg-slate-950/30 p-4">
        ...
        <div className="mt-2 text-sm text-slate-400">Use este painel para tensionar a leitura: causa raiz, risco, caixa, dívida e direção recomendada.</div>
        <textarea value={question} onChange={(e) => setQuestion(e.target.value)} placeholder="Pergunte algo sobre causa raiz, cenário, risco, dívida ou recomendação..." className="mt-3 w-full min-h-28 rounded-lg border border-slate-700 bg-slate-950/40 px-3 py-2 text-sm text-slate-200" />
