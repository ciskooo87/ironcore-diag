...
export function DeliverablePreviewPanel({ projectId }: { projectId: string }) {
  ...
  return (
    <section className="mt-6 rounded-3xl border border-black/5 bg-white p-5 md:p-6">
      <div className="text-[11px] uppercase tracking-[0.24em] text-[#667085]">Preview dos deliverables</div>
